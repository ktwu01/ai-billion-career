...
Deno.serve(async (req) => {
    ...
    bucketConfig.allowed_mime_types = ["image/*", "application/pdf"];
    ...
    const policyQueries = [
        ...
        `CREATE POLICY "Public Access for achievement-certificates" ON storage.objects FOR SELECT USING (bucket_id = 'achievement-certificates');`,
        // Allow public to insert objects in this bucket
        `CREATE POLICY "Public Upload for achievement-certificates" ON storage.objects FOR INSERT WITH CHECK (bucket_id = 'achievement-certificates');`,
        // Allow public to update objects in this bucket
        `CREATE POLICY "Public Update for achievement-certificates" ON storage.objects FOR UPDATE USING (bucket_id = 'achievement-certificates');`,
        // Allow public to delete objects in this bucket
        `CREATE POLICY "Public Delete for achievement-certificates" ON storage.objects FOR DELETE USING (bucket_id = 'achievement-certificates');`
    ];
